...
int camera()
{
    ...
    Shader cameraShader("Shader/x_interiorMapping_vs.vert", "Shader/x_interiorMapping_fs.frag");
...
#pragma mark 纹理1
    ...
    // 设置stb_image在加载时垂直翻转纹理
    stbi_set_flip_vertically_on_load(true);

    unsigned char* data = stbi_load("Resource/XYZ.png", &width, &height, &nrChannels, 0);
    ...
    glUniform1f(glGetUniformLocation(cameraShader.shaderProgramID, "roomDepth"), 0.5f);
